...
func (p *TPlanNodeExecSummary) Equals(other *TPlanNodeExecSummary) bool {
	...
	if p.FragmentIdx != other.FragmentIdx {
		return false
	}
	...
	if !p.EstimatedStats.Equals(other.EstimatedStats) {
		return false
	}
...
func (p *TExecSummary) Equals(other *TExecSummary) bool {
	...
	if len(p.ExchToSenderMap) != len(other.ExchToSenderMap) {
		return false
	}
	...
	if len(p.ErrorLogs) != len(other.ErrorLogs) {
		return false
	}
	...
	if !p.Progress.Equals(other.Progress) {
		return false
	}
