...
func (p Type) String() string {
	...
	case Type_UBSAN_FORCE_WIDTH:
		return "UBSAN_FORCE_WIDTH"
	}
	return "<UNSET>"
}
...
func TypeFromString(s string) (Type, error) {
	...
	case "UBSAN_FORCE_WIDTH":
		return Type_UBSAN_FORCE_WIDTH, nil
	}
...
func EncodingFromString(s string) (Encoding, error) {
	...
	case "MAX_ENUM_VALUE":
		return Encoding_MAX_ENUM_VALUE, nil
	}
