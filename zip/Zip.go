...
func (p *TExtractFromZipParams) Read(iprot thrift.TProtocol) error {
...
func (p *TExtractFromZipParams)  ReadField1(iprot thrift.TProtocol) error {
...
func (p *TExtractFromZipParams)  ReadField2(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadString(); err != nil {
...
func (p *TExtractFromZipParams) Write(oprot thrift.TProtocol) error {
  if err := oprot.WriteStructBegin("TExtractFromZipParams"); err != nil {
...
func (p *TExtractFromZipParams) writeField1(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("archive_file", thrift.STRING, 1); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 1:archive_file: ", p), err) }
  if err := oprot.WriteString(string(p.ArchiveFile)); err != nil {
...
func (p *TExtractFromZipParams) writeField2(oprot thrift.TProtocol) (err error) {
  if err := oprot.WriteFieldBegin("destination_dir", thrift.STRING, 2); err != nil {
    return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:destination_dir: ", p), err) }
  if err := oprot.WriteString(string(p.DestinationDir)); err != nil {
